...
function age() {
  // Create a new Date object representing the date of birth (DOB)
  var dob = new Date(2003, 5, 17);
  // Calculate the difference in milliseconds between the current date and time and the DOB
  var diff_ms = Date.now() - dob.getTime();
  // Create a new Date object representing the age based on the difference in milliseconds
  var age_dt = new Date(diff_ms);
  // Calculate the full years represented by the age_dt date object
  // Subtract 1970 because age_dt represents the time duration since 1970
            ...
            <div className="lg:mx-40">
              <div className="grid lg:grid-cols-3 md:gap-4 lg:gap-8 max-w-6xl mx-auto my-8">
                <div className="bg-gray-400/20 w-auto my-auto lg:mx-2 mx-auto custom-shape-div p-1 rounded-full">
                  <img
                    src="/dp6/dpaulos6.jpg"
                    className="h-auto max-h-80 lg:max-h-96 mx-auto shadow-lg shadow-gray-500/60 rounded-full"
                    alt="dpaulos6"
                  ></img>
                </div>
                <div className="mx-10 sm:mx-20 md:mx-32 my-5 lg:my-auto lg:mx-2 lg:col-span-2">
                  <p className="text-lg md:text-xl lg:text-2xl text-justify text-gray-800 my-3">
                    My name is Diogo Paulos, I'm {age()} years old and I'm from
                    Portugal.
                  </p>
                  <span className="text-lg md:text-xl lg:text-2xl text-justify text-gray-800 my-3">
                    I love to write and learn code, specially trying out new
                    things and learning useful programming languages. I enjoy
                    learning frameworks and recently i've been loving{" "}
                    <code className="link-modern-light text-blue-500">
                      <a
                  ...
                  <p className="text-lg md:text-xl lg:text-2xl text-justify text-gray-800 my-3">
                    I also love to play video-games with my friends, listen and
                    produce music, edit videos or photos, and much more.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="border-t border-gray-200">
            <dl>
              ...
              <div className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                ...
                <dd className="mt-1 text-base text-gray-900 sm:col-span-2 sm:mt-0 hover:text-blue-600">
                  <a
              ...
              <div className="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                ...
                <dd className="mt-1 text-base text-gray-900 sm:col-span-2 sm:mt-0">
                  English{" "}
                  <p className="inline-flex text-sm text-gray-500">B1 Level</p>
                </dd>
              </div>
              <div className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                <dt className="text-base font-medium text-gray-500">
                    ...
                    <li className="flex items-center justify-between py-3 pl-3 pr-4 text-base">
                      <div className="flex w-full flex- items-center">
                        <PaperClipIcon
                          ...
                          aria-hidden="true"
                        />
                        <span className="ml-2 w-fit truncate transition-all">
                          dpaulos6-cv.pdf
                        </span>
                        <span className="ml-4 text-gray-600 text-sm">
                          Soon will be available to preview or download.
                        </span>
                      </div>
